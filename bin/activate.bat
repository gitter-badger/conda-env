...
if "%CONDA_DEFAULT_ENV%" == "" goto skipdeactivate
    ...
    set "CONDACTIVATE_PATH=%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%;%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%\Scripts;%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%\Library\bin;%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%\Library\lib"
...
set "PATH=%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%;%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%\Scripts;%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%\Library\bin;%ANACONDA_ENVS%\%CONDA_DEFAULT_ENV%\Library\lib;%PATH%"
